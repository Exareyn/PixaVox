...
if not os.getcwd() == '/home/titouan/Delivery/PGE3/Eip/Forward/':
    os.chdir('/home/titouan/Delivery/PGE3/Eip/Forward/')


your_mesh = mesh.Mesh.from_file('uploads_files_82986_300_polygon_sphere_100mm.STL') #the stl file you want to voxelize
...
def intersect(triangle,point,vector,origin):
    ...
    print(f"Check if point ({x,y,z}) is on the triangle border")
...
def LinePlaneCollision(triangle,planeNormal, planePoint, rayDirection, rayPoint,point, epsilon=1e-6):
    ...
    print(f"Check if cube diag cross the triangle in the cube")
